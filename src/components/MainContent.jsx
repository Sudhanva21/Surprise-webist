    ...
    const pages = [
        ...
        <StoryPage key="journey" backgroundColor="bg-gradient-to-br from-blue-200 to-green-200">
            ...
            <div className="space-y-4 flex-1 overflow-y-auto overflow-x-hidden rounded-xl custom-scrollbar">
                {[
                    { date: '26 January, 2023', event: 'Our Journey Began', emoji: '❤️' },
                    { date: '21 Feb, 2023', event: 'First Date Together and that ring', emoji: '🎬' },
                    { date: '18 Januray, 2023', event: 'First Hug near c wing', emoji: '🤗' },
                    { date: '18 August, 2023', event: 'My first expensive gift to you', emoji: '✈️' },
                    { date: '10 November, 2023', event: 'First Diwali together', emoji: '💬' },
                    { date: '31 December, 2023', event: 'First New year Together', emoji: '🎄' },
                ]
                    .map((item, index) => (
                        <motion.div
                            key={index}
